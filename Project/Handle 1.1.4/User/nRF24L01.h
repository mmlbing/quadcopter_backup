...
#define nRF24L01_CE_LOW					GPIOB->BRR  = GPIO_Pin_8
#define nRF24L01_CE_HIGH				GPIOB->BSRR = GPIO_Pin_8

#define nRF24L01_CSN_LOW				GPIOB->BRR  = GPIO_Pin_7
#define nRF24L01_CSN_HIGH				GPIOB->BSRR = GPIO_Pin_7

#define	nRF24L01_IRQ						(GPIOB->IDR & 0x20)
...
#define TX_PLOAD_WIDTH  11   //20字节的用户数据宽度
#define RX_PLOAD_WIDTH  11   //20字节的用户数据宽度
