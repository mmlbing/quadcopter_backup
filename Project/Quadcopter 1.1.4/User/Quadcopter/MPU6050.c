...
void MPU6050_Get_PRY(void)
{
	...
	{
		if( ((gyro[0]-gyrolast[0])>20000)||((gyro[0]-gyrolast[0])<-20000) )
			gyro[0] = gyrolast[0];
		if( ((gyro[1]-gyrolast[1])>20000)||((gyro[1]-gyrolast[1])<-20000) )
			gyro[1] = gyrolast[1];
		if( ((gyro[2]-gyrolast[2])>20000)||((gyro[2]-gyrolast[2])<-20000) )
			gyro[2] = gyrolast[2];
