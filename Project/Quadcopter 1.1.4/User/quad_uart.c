...
void UAR1_ReportPID(void)
{
	char cdata[10];
	sprintf(cdata,"%.3f",pid.outP);
	PrintChar("P:");
	PrintChar(cdata);
	
	sprintf(cdata,"%.3f",pid.outI);
	PrintChar("  I:");
	PrintChar(cdata);
	
	sprintf(cdata,"%.3f",pid.outD);
	PrintChar("  D:");
	PrintChar(cdata);
	PrintChar("\n");
}
...
void UAR1_ReportPRY(void)
{
	char cdata[10];
	
	sprintf(cdata,"%.3f",pid.pryPitch);
	PrintChar("Pitch   :");
	PrintChar(cdata);
	sprintf(cdata,"%.3f",pid.pryRoll);
	PrintChar("  Roll   :");
	PrintChar(cdata);
	PrintChar("\n");
	
	sprintf(cdata,"%.3f",pid.pryPitchCom);
	PrintChar("PitchCom:");
	PrintChar(cdata);
	sprintf(cdata,"%.3f",pid.pryRollCom);
	PrintChar("  RollCom:");
	PrintChar(cdata);
	PrintChar("\n");
}
